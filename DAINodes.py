...
from NodeGraphQt import BaseNode, NodeBaseWidget, NodeGraph, setup_context_menu
...
class IMUNode(DepthAINode):
    ...
    def __init__(self):
        ...
        self.add_checkbox(
            "GYROSCOPE_UNCALIBRATED", "GYROSCOPE_UNCALIBRATED", state=False
        )
        self.add_checkbox("MAGNETOMETER_RAW", "MAGNETOMETER_RAW", state=False)
        self.add_checkbox(
            "MAGNETOMETER_CALIBRATED", "MAGNETOMETER_CALIBRATED", state=False
        )
        self.add_checkbox(
            "MAGNETOMETER_UNCALIBRATED", "MAGNETOMETER_UNCALIBRATED", state=False
        )
        ...
        self.add_checkbox(
            "GEOMAGNETIC_ROTATION_VECTOR", "GEOMAGNETIC_ROTATION_VECTOR", state=False
        )
        self.add_checkbox(
...
class MobileNetSpatialDetectionNetworkNode(DepthAINode):
    ...
    def __init__(self):
        ...
        self.add_output(
            "boundingBoxMapping", data_type="SpatialLocationCalculatorConfig"
        )
        ...
        self.add_float_input(
            "upper_depth_threshold", "Upper Depth Threshold (mm)", 5000
        )
